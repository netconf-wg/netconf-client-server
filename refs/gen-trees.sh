...
pyang  -f tree --tree-line-length 69 --tree-no-expand-uses ietf-netconf-client\@*.yang > ietf-netconf-client-tree-no-expand.txt
pyang  -f tree --tree-line-length 69 --tree-no-expand-uses ietf-netconf-server\@*.yang > ietf-netconf-server-tree-no-expand.txt
...
extract_grouping_with_params() {
  ...
  # $4 output filename
  pyang  -f tree --tree-line-length 69 --tree-print-groupings $3 $1@*.yang | gsed -e 's/grouping netconf-client-grouping/grouping netconf-client-grouping ---> <empty>/' -e '/^\( *\)+-- netconf-client-parameters/a\                +---u ncc:netconf-client-grouping' -e '/|     +-- netconf-client-parameters/a\       |        +--u ncc:netconf-client-grouping' > $1-groupings-tree.txt
